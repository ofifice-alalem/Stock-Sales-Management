...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-white">المحلات</h1>
</div>

<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    @foreach($stores as $store)
    <div class="stat-card rounded-2xl p-6 border border-white/5 shadow-xl hover:border-blue-500/30 transition-all">
        <div class="flex flex-col h-full">
            ...
            <div class="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                ...
                <p class="text-2xl font-bold text-red-400">{{ number_format($store->remaining, 2) }} دينار</p>
            </div>
...
<div class="stat-card rounded-2xl p-12 border border-white/5 shadow-xl text-center">
    ...
    <p class="text-gray-400 text-lg">لا توجد محلات بديون حالياً</p>
</div>
@endif
@endsection
